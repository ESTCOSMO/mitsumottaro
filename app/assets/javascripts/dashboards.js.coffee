...
$ () ->
  ...
  # copy item
  #
  $("[id^=copy-item_]").on "click", ->
    item_copy_modal = $("#item-copy-modal")
    project_id = $(".project_id").text()
    css_id = $(this).attr("id")
    splitted = css_id.replace("copy-item_", "").split("_")
    ...
    if splitted.length == 1
      ...
      item_copy_modal.find("#copy_item_category_id").empty()
      ...
      item_copy_modal.find("#copy_item_category_id").empty()
      item_copy_modal.find("#copy_item_category_id").append(category_options)
      item_copy_modal.find(".dst_sub_category").hide()
      item_copy_modal.find("#copy_item_sub_category_id").empty()
    else
  ...
  $("#item-copy-modal").find("#copy_item_category_id").on "change", ->
    item_copy_modal = $("#item-copy-modal")
    item_copy_modal.find("#copy_item_sub_category_id").empty()
    selected_category_id = item_copy_modal.find("#copy_item_category_id").val()
    if selected_category_id
      sub_category_options_list = JSON.parse(item_copy_modal.find(".sub_category_options_list").html())
      item_copy_modal.find("#copy_item_sub_category_id").append(sub_category_options_list[selected_category_id])
