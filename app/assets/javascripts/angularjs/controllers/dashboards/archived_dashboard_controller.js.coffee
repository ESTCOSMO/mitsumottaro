angular.module('projectsControllers').controller 'ArchivedDashboardController', ['$scope', 'Project', 'Category','SubCategory', 'Story', 'TaskPoint', 'MoveHigherCategory', 'MoveLowerCategory', 'MoveHigherSubCategory', 'MoveLowerSubCategory', 'MoveHigherStory', 'MoveLowerStory', 'CopyCategory', 'CopySubCategory', 'CopyStory', '$routeParams', '$sce', '$modal', '$window', ($scope, Project, Category, SubCategory, Story, TaskPoint, MoveHigherCategory, MoveLowerCategory, MoveHigherSubCategory, MoveLowerSubCategory, MoveHigherStory, MoveLowerStory, CopyCategory, CopySubCategory, CopyStory, $routeParams, $sce, $modal, $window) ->
