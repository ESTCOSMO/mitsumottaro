angular.module('projectsControllers').controller 'CommonDashboardController', ['$scope', 'Project', 'Category','SubCategory', 'Story', 'TaskPoint', '$routeParams', '$modal', '$window', ($scope, Project, Category, SubCategory, Story, TaskPoint, $routeParams, $modal, $window) ->
