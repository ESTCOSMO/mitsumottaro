...
describe Api::CategoriesController, :type => :routing do
  describe 'routing' do
    describe 'routes to #show' do
      context 'when using url,' do
        subject{ { get:'/api/projects/1/categories/2' } }
        it{ is_expected.to be_routable }
        it{ is_expected.to route_to(controller: 'api/categories', action: 'show', project_id: '1', id: '2') }
      end
    ...
    describe 'routes to #move_higher' do
      context 'when using url,' do
        ...
        it{ is_expected.to be_routable }
        it{ is_expected.to route_to(controller: 'api/categories', action: 'move_higher', project_id: '1', id: '2') }
      end
      context 'when using prefix_path,' do
    ...
    describe 'routes to #move_lower' do
      context 'when using url,' do
        ...
        it{ is_expected.to be_routable }
        it{ is_expected.to route_to(controller: 'api/categories', action: 'move_lower', project_id: '1', id: '2') }
      end
      context 'when using prefix_path,' do
    ...
    describe 'routes to #create' do
      ...
      it{ is_expected.to be_routable }
      it{ is_expected.to route_to(controller: 'api/categories', action: 'create', project_id: '1') }
    end
    describe 'routes to #update' do
      subject{ { put:'/api/projects/1/categories/2' } }
      it{ is_expected.to be_routable }
      it{ is_expected.to route_to(controller: 'api/categories', action: 'update', project_id: '1', id: '2') }
    end
    describe 'routes to #destroy' do
      subject{ { delete: '/api/projects/1/categories/2' } }
      it{ is_expected.to be_routable }
      it{ is_expected.to route_to(controller: 'api/categories', action: 'destroy', project_id: '1', id: '2') }
    end
  end
end
